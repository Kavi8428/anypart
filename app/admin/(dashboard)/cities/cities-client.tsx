...
export function CitiesClient({ data, districts }: { data: any[], districts: any[] }) {
    ...
    async function onSubmit(formData: FormData) {
        startTransition(async () => {
            let res;
            if (editing) {
                res = await updateCity(editing.id, formData)
            } else {
    ...
    return (
        <>
            <PageHeader
                title="Cities"
                description="Manage valid cities and their district associations."
                action={
