...
function ComboboxList({ className, style, ...props }: ComboboxPrimitive.List.Props) {
  return (
    <ComboboxPrimitive.List
      ...
      style={{ maxHeight: 'var(--available-height, 300px)', overflowY: 'auto', ...style }}
      className={cn(
